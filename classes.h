...
enum parameters {ELEMENT_LENGTH, P_T, P_K, P_Y, P_V, P_W, P_C, P_S, P_N};
...
class mesh{
    ...
    public:
        void setParameters(float l,float pt, float pk, float py, float pv, float pw, float pc, float ps, float pn){
